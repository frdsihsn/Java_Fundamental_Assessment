...
public class CourseService
{
    ...
    public void unEnrollStudent(String courseId, Student student)
    {
            enrolledStudents.get(courseId).remove(student);
    }

    public List<Student> showEnrolledStudents( String courseId )
    {
        List<Student> students = new ArrayList<>();
        if ( enrolledStudents.containsKey( courseId ) ) {
            students = enrolledStudents.get(courseId);
